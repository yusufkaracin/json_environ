...
The sources for JSON Environ can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/yusufkaracin/json_environ
.. _tarball: https://github.com/yusufkaracin/json_environ/tarball/master
